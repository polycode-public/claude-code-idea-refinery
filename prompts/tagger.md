...
4. Name each cluster with a kebab-case tag that names what its members actually share,
   not a tag borrowed from whichever member happens to sort first. Two clusters never
   get the same name.
