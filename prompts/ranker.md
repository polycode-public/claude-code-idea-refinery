...
2. Graduation, your only judgment call. An idea in `ideas-3-refined/` or
   ...
   an idea with no challenger comment has skipped the test, not passed it; and its
   `## Steps to realise` section carries at least one numbered step, where the seeded
   placeholder counts as absence. What graduation does depends on where the idea
